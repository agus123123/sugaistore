...
function updateKodePesanan() {
    var today = new Date();
    var year = today.getFullYear();
    var month = String(today.getMonth() + 1).padStart(2, '0');
    var day = String(today.getDate()).padStart(2, '0');
    var formattedDate = year + month + day;
    var currentCode = localStorage.getItem('kodeUrut') || 1;
    var kodePesanan = formattedDate + String(currentCode).padStart(3, '0');
    document.getElementById('kode_pesanan').value = kodePesanan;
    localStorage.setItem('kodeUrut', parseInt(currentCode) + 1);
}
...
var idGame = document.getElementById('id_game').value;
    ...
    var kodePesanan = document.getElementById('kode_pesanan').value;

    var pesanWhatsApp = "FORM TOP UP by *SUGAI STORE*✨\n\n";
    pesanWhatsApp += "*KODE PESANAN :* " + kodePesanan + "\n";
    ...
    pesanWhatsApp += "*METODE PEMBAYARAN :* " + metodePembayaran;
window.location.href = "https://wa.me/6281399472786?text=" + encodeURIComponent(pesanWhatsApp);
}
